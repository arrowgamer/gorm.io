...
**WARNING** When deleting a record, you need to ensure its primary field has value. GORM will use the primary key to delete the record. If the primary field is blank, GORM will delete all records for the model
